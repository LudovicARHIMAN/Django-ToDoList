...
from .api.serializers import ToDoListSerializers, ItemSerializers
...
class ToDoListView(APIView):
    '''
    Créer et visualiser les Listes via l'API
    '''
...
class ItemView(APIView):
    '''
    Ajouter des items dans un liste spécifique
    '''
   #permission_classes = (IsAuthenticated,)

    def get(self, request):
            queryset = ToDoList.objects.get(id=16).item_set.all()
